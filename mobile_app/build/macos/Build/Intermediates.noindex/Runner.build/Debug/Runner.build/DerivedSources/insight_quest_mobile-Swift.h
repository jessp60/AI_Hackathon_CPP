...
#ifndef INSIGHT_QUEST_MOBILE_SWIFT_H
#define INSIGHT_QUEST_MOBILE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="insight_quest_mobile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC20insight_quest_mobile11AppDelegate")
...
SWIFT_CLASS("_TtC20insight_quest_mobile17MainFlutterWindow")
